          ...
          <SidebarProvider className="min-h-full bg-background">
            ...
            <div className="bg-background w-full h-full flex-1 md:px-2 lg:px-0">
              <div className="flex items-stretch text-sm sm:text-base w-full">
                ...
                <div className="border-l sticky top-[calc(var(--header-height))] z-30 ml-auto hidden h-[calc(100svh-var(--header-height)-var(--footer-height))] w-72 flex-col gap-4 overflow-hidden overscroll-none pb-8 xl:flex">
                  {schedule}
                </div>
              </div>
            </div>
